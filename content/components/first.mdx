  ...
  <table className="border-collapse w-full">
    ...
    <tbody>
      <tr>
        ...
        <td className="border border-gray-300 px-4 py-2">Bitcoin to USD price feed with 18 decimals</td>
      ...
      <tr>
        ...
        <td className="border border-gray-300 px-4 py-2">Ethereum to USD price feed with 18 decimals</td>
      ...
      <tr>
        ...
        <td className="border border-gray-300 px-4 py-2">Solana to USD price feed with 18 decimals</td>
      ...
      <tr>
        ...
        <td className="border border-gray-300 px-4 py-2">Tether to USD price feed with 18 decimals</td>
      ...
      <tr>
        ...
        <td className="border border-gray-300 px-4 py-2">USD Coin to USD price feed with 18 decimals</td>
      ...
      <tr>
        <td className="border border-gray-300 px-4 py-2 font-medium">Valueless\_Test/USD</td>
        <td className="border border-gray-300 px-4 py-2">Test feed with 18 decimals for development</td>
        <td className="border border-gray-300 px-4 py-2 font-mono text-sm">`0x000369f643e4e5d9b9d04863249c07c15937d0b36af803dd8d213827b0badd5c`</td>
      </tr>
    </tbody>
  </table>
</div>
