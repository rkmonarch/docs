...
<Frame>
  <div className="my-8">
    <img src="/api/soon/oracle-flow.svg" alt="APRO Oracle Data Flow" className="w-full" />
  </div>
</Frame>
...
<div className="not-prose">
  <table className="border-collapse w-full">
    ...
    <tbody>
      <tr>
        <td className="border border-gray-300 px-4 py-2">Apro_SVM_Oracle</td>
      ...
      <tr>
        <td className="border border-gray-300 px-4 py-2">Sample_Client</td>
